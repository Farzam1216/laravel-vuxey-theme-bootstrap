...
class CarDatatable extends DataTable
{
  ...
  protected function getColumns(): array
  {
    ...
    $columns = [
      ...
      Column::make('brand_name')->title('Brand Name')->addClass('text-nowrap'),
      ...
      Column::make('owner_name')->title('Owner Name')->addClass('text-nowrap'),
      Column::make('owner_contact_no')->title('Owner Contact No.')->addClass('text-nowrap'),
