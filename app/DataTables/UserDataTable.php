...
class UserDataTable extends DataTable
{
  ...
  public function dataTable(QueryBuilder $query)
  {
    ...
    $editColumns = (new EloquentDataTable($query))
      ...
      ->editColumn('roles', function ($user) {
        $originalString = implode(',', $user->roles->pluck('name')->toArray());
        $updatedString = removeDigitsFromString($originalString);
      ...
      ->editColumn('actions', function ($user) {
        return '
                <div class="d-flex justify-content-cetner align-items-center" onclick="users_menu(' . $user->id . ')">
                    <div class="btn-group">
  ...
  {
    return $this->userInterface->model()->newQuery()
  ...
  protected function getColumns(): array
  {
    ...
    $editPermission = Auth::user()->hasPermissionTo('users.edit');
    $columns = [
      ...
      // ),
      Column::computed('name')->title('Name')->addClass('text-nowrap')->searchable(true)->orderable(true),
      Column::make('email')->title('Email')->addClass('text-nowrap'),
      Column::make('mobile_no')->title('Contact')->addClass('text-nowrap'),
      Column::computed('roles')->title('Roles')->addClass('text-nowrap'),
