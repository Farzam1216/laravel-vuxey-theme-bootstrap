...
/***/ "./resources/assets/vendor/libs/filepond/filepond.min.js":
/*!***************************************************************!*\
  !*** ./resources/assets/vendor/libs/filepond/filepond.min.js ***!
  \***************************************************************/
...
(function (global, factory) {
  ...
  var thereYet = function thereYet(position, destination, velocity) {
    var errorMargin = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : .001;
    return Math.abs(position - destination) < errorMargin && Math.abs(velocity) < errorMargin;
  };
  var spring = function spring() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$stiffness = _ref.stiffness,
      stiffness = _ref$stiffness === void 0 ? .5 : _ref$stiffness,
      _ref$damping = _ref.damping,
      damping = _ref$damping === void 0 ? .75 : _ref$damping,
      _ref$mass = _ref.mass,
  ...
  var toBytes = function toBytes(value) {
    var base = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1e3;
    if (isInt(value)) {
      return value;
    }
  ...
  var actions = function actions(dispatch, query, state) {
    return {
      ...
      REQUEST_ITEM_PROCESSING: getItemByQueryFromState(state, function (item, success, failure) {
        var itemCanBeQueuedForProcessing = item.status === ItemStatus.IDLE || item.status === ItemStatus.PROCESSING_ERROR;
        if (!itemCanBeQueuedForProcessing) {
          ...
          if (item.status === ItemStatus.PROCESSING_COMPLETE || item.status === ItemStatus.PROCESSING_REVERT_ERROR) {
            item.revert(createRevertFunction(state.options.server.url, state.options.server.revert), query("GET_FORCE_REVERT")).then(process)["catch"](function () {});
  ...
  var toNaturalFileSize = function toNaturalFileSize(bytes) {
    ...
    var base = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1e3;
  ...
  var getItemHeight = function getItemHeight(child) {
    return child.rect.element.height + child.rect.element.marginBottom * .5 + child.rect.element.marginTop * .5;
  };
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/libs/filepond/filepond.min.js");
/******/ 	
