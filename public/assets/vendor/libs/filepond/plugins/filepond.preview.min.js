...
/***/ "./resources/assets/vendor/libs/filepond/plugins/filepond.preview.min.js":
/*!*******************************************************************************!*\
  !*** ./resources/assets/vendor/libs/filepond/plugins/filepond.preview.min.js ***!
  \*******************************************************************************/
...
(function (global, factory) {
  ...
  var updateEllipse = function updateEllipse(element) {
    var cx = element.rect.x + element.rect.width * .5;
    var cy = element.rect.y + element.rect.height * .5;
    var rx = element.rect.width * .5;
    var ry = element.rect.height * .5;
  ...
  var updateLine = function updateLine(element, markup, size, scale) {
    ...
    var l = getMarkupValue(.05, size, scale);
  ...
  var getImageRectZoomFactor = function getImageRectZoomFactor(imageRect, cropRect, rotation, center) {
    var cx = center.x > .5 ? 1 - center.x : center.x;
    var cy = center.y > .5 ? 1 - center.y : center.y;
  ...
  var getCenteredCropRect = function getCenteredCropRect(container, aspectRatio) {
    ...
    var x = (container.width - width) * .5;
    var y = (container.height - height) * .5;
    return {
      x: x,
      y: y,
      width: width,
  ...
  var createImageWrapperView = function createImageWrapperView(_) {
    ...
    var drawPreview = function drawPreview(_ref6) {
      ...
      var previewImageLoaded = function previewImageLoaded(imageData) {
        ...
        var pixelDensityFactor = Math.max(1, window.devicePixelRatio * .75);
    ...
    var didThrowError = function didThrowError(_ref10) {
      ...
      root.ref.overlayShadow.opacity = .25;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/libs/filepond/plugins/filepond.preview.min.js");
/******/ 	
