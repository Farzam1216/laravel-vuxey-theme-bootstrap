...
{{-- @section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'users.edit', encryptParams($site_id)) }}
@endsection --}}
        ...
        <div class="row breadcrumbs-top mb-0">
            <div class="col-12 align-items-center d-flex">
                ...
                <div class="breadcrumb-wrapper align-items-center d-flex">
                    {{ Breadcrumbs::render('users.edit', encryptParams($site_id)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <form id="userForm" class="form form-vertical" enctype="multipart/form-data"
        action="{{ route('users.update', [ 'id' => encryptParams($user->id)]) }}"
        method="POST">
