...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.users.show', encryptParams($site_id)) }}
@endsection
...
@endsection
@section('page-css')
    <link rel="stylesheet" href="{{ asset('new_theme/assets/vendor/css/pages/page-user-view.css') }}" />
    <link rel="stylesheet" href="{{ asset('new_theme/assets/vendor/css/rtl/core.css') }}" />
    <link rel="stylesheet" href="{{ asset('new_theme/assets/vendor/css/rtl/theme-default.css') }}" />
@endsection
@section('page-css')
    ...
    <div class="content-header-left col-md-9 col-12">
        <div class="row breadcrumbs-top mb-0">
            <div class="col-12 align-items-center d-flex">
                <h2 class="content-header-title float-start mb-0">Preview User</h2>
                <div class="breadcrumb-wrapper align-items-center">
                    {{ Breadcrumbs::render('sites.users.show', encryptParams($site_id)) }}
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <div class="user-avatar-section">
                                <div class="d-flex align-items-center flex-column">
                                    ...
                                    @if (Str::length($photo) > 0)
                                        <div class="main_pdf" style="display: grid; margin-left: 0.5rem;">
                                            <iframe src="{{ $photo }}" height="250px" width="250px"
                                                target="_blank">
                                            </iframe>
                                        </div>
                                  @endif
                            ...
                            <div class="info-container">
                                ...
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('sites.users.edit', ['site_id' => encryptParams($site_id), 'id' => encryptParams($id)]) }}"
                                        class="btn btn-primary me-3" data-bs-target="#editUser"
                                        data-bs-toggle="">Edit</a>
                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="app-user-view-security.html"><i
                                    class="ti ti-lock ti-xs me-1"></i>Security</a>
                        </li>
                        <li class="nav-item">
...
@section('page-js')
    <script src="{{ asset('new_theme/assets/vendor/js/menu.js') }}"></script>
    <script src="{{ asset('new_theme/assets/js/modal-edit-user.js') }}"></script>
    <script src="{{ asset('new_theme/assets/js/app-user-view.js') }}"></script>
    <script src="{{ asset('new_theme/assets/js/app-user-view-account.js') }}"></script>
@endsection
