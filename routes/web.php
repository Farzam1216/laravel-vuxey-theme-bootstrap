...
// Route::get('/register', [App\Http\Controllers\RentCar\RegisterController::class, 'index'])->name('register');
// Route::get('/login', [App\Http\Controllers\RentCar\RegisterController::class, 'index'])->name('login');

// Route::post('/register-users', [App\Http\Controllers\RentCar\RegisterController::class, 'store'])->name('register-users');
...
Route::group(['middleware' => ['auth', 'permission']], function () {
  ...
  Route::group(['prefix' => 'roles', 'as' => 'roles.'], function () {
    ...
    Route::post('/ajax-roles-menu/{id}', [RoleController::class, 'roles_menu'])->name('ajax-roles-menu');
  });
...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::post('/store-car-review', [App\Http\Controllers\CarReviewsController::class, 'store'])->name('store-car-review');
});
